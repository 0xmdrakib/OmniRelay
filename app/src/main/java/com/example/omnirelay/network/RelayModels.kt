...
@Serializable
data class ChallengeResponse(val deviceId: String, val nonceBase64: String)
...
@Serializable
data class CallStateRequest(val state: String, val envelopeId: String, val frameBase64: String)
